// TODO: replace margin parameter with scale parameter as a means for
// making the central image take up more or less of the overall
// canvas.
  ...
  switch (options.position) {
    case 'centre':
      ...
      if (inY / inX > canvY / canvX) { // slack width
        ...
        let slack = canvX - outX;
        outputRegion = { 
          o: [
            Math.floor(slack / 2) + options.margin,
            outY - options.margin
          ],
